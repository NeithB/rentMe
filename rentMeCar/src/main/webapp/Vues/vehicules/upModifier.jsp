...
<main id="principal_inscr" style="height:74vh;">
	...
	<h1 class="log" id="">Modifier/Vehicules</h1>
			...
			<div class="row" >
					<div class="col-6">			
							...
							<div hidden  class="mb-2">	
								<input type="text" class="form-control inputVerif" value="<c:out value="${vehicule.idV }" />"  name="idV" placeholder="Veillez indiquer la marque" minlength="2" maxlength="15">
							</div>
						...
						<div class="col-6">
							...
							<div class="mb-2">
								<input type="number" class="form-control inputPrix" value="<c:out value="${vehicule.prixJ}" />"  name="prix" placeholder="Veillez indiquer le prix Journalier" >
							</div>
						</div>						
					</div>
					<div class="">
							<button type="submit" class="btn btn-primary inputSubmit form-control" id="insc" value="upVcl" name="action">Modifier/Vehicule</button>
					</div>
			</div>
		</form>	
