...
public class userFormModifier {
	 ...
	 public Membre getUser(HttpServletRequest request) throws ParseException {
		 ...
		 String statut=isValide(STATUT,request.getParameter(STATUT),2,6);
		...
		Membre membre =new Membre(0, prenom, nom, login, mdp, tel, email, statut, cp, ville, statut, dateIns);
